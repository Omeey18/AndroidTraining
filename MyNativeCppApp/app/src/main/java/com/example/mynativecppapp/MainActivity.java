package com.example.mynativecppapp;
...
import com.example.mynativecppapp.databinding.ActivityMainBinding;

public class MainActivity extends AppCompatActivity {

    // Used to load the 'mynativecppapp' library on application startup.
    static {
        System.loadLibrary("mynativecppapp");
    }
